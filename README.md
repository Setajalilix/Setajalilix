...
const SETAYESH = [
        ...
        "tools" => ["Laravel", "TailwindCSS", "Postman", "MySQL"],
        ];
```
## Tools 
<div align="center">
...
<!--
**Setajalilix/Setajalilix** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
